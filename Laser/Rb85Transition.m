% Rb85 high level Transition Dectection
% stuart smyth
% 14 jun 18
...
title('Rb85 Transition detection')
xlabel('time(s)')
ylabel('y')
subplot(4,1,2),plot(lag85,C85,ytim,ypks,'o m')
title('C85 vs lag')
xlabel('Lag (samples)')
ylabel('C85')
xlim( [0 6250])
...
xlabel('time(s)')
ylabel('dy/dt')
subplot(4,1,4),plot(lag85g,C85g,dytim,dypks,'o m')
title('C85g vs lag')
xlabel('Lag (samples)')
ylabel('C85 Grad')
xlim( [0 6250])